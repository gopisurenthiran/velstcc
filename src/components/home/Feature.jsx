...
import featuredbanner from "@/public/images/featurted_image.png";
    ...
    */}
    ...
    <div className="relative w-full h-full min-h-[300px] md:min-h-[400px]">
        ...
        <div className="flex-1 p-8 bg-black-50 rounded-lg">
            <h2 className="text-3xl font-baskervville  mt-4  font-bold text-black mb-2">The Landmark of Unmatched 
<br></br>Scale & Excellence</h2>
            <p className="text-gray-700 font-founders leading-loose	">
              ...
              <h2 className="text-3xl font-baskervville mt-2 font-bold text-black  mb-2">Bigger. Better. Beyond Compare.</h2>
